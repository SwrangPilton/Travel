                ...
                <div className="row">
                    <div className="col-lg-3">
                        ...
                        <p style={{ fontSize: '0.9rem' }}>
                            Bodoland, officially the Bodoland Territorial Region,
                            is an autonomous region in Assam, Northeast India.
                            It is made up of four districts on the north bank
                            of the Brahmaputra river below the foothills of
                    ...
                    <div className="col-lg-2 col-md-6" id="contactus">
                        <h4>CONTACTS</h4>
                        <ul>
